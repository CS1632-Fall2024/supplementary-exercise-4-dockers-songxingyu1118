...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//a[contains(text(),\'Reset\') and contains(@href, \'/reset\')]"));
  ...
  public void dEFECT1FUNFEEDACAT() {
    driver.get("http://localhost:8080/");
    driver.manage().window().setSize(new Dimension(840, 834));
  ...
  public void dEFECT3FUNFEEDACAT() {
    ...
    driver.findElement(By.id("catnips")).sendKeys("3.3");
